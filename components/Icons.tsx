/**
 * Icons — Bibliothèque d'icônes SVG inline (style Lucide)
 * Taille standard 16x16. Ajouter aria-hidden="true" sur chaque usage dans un bouton.
 * Pour les boutons icône seul, ajouter aria-label sur le bouton parent.
 */
...
const icon = (path: React.ReactNode, opts?: { size?: number }) =>
...
export const IconCalculator = icon(<><rect x="4" y="2" width="16" height="20" rx="2"/><line x1="8" y1="6" x2="16" y2="6"/><line x1="16" y1="10" x2="16" y2="14"/><line x1="8" y1="10" x2="8" y2="10"/><line x1="12" y1="10" x2="12" y2="10"/><line x1="8" y1="14" x2="8" y2="14"/><line x1="12" y1="14" x2="12" y2="14"/><line x1="8" y1="18" x2="12" y2="18"/></>);
...
export const IconPlane = icon(<><path d="M17.8 19.2 16 11l3.5-3.5C21 6 21 4 19 2c-2-2-4-2-5.5-.5L10 5 1.8 6.2c-.5.1-.9.5-.8 1l.5 2c.1.5.5.9 1 .8L7 9.5 5.4 14 4 15l1 1 1-1.4L9 11l5.5 1.5c.5.1.9.5 1 1l.5 2c.1.5.5.9 1 .8l2-1c.5-.1.9-.5.8-1z"/></>);
export const IconTrendingUp = icon(<><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></>);
export const IconGraduation = icon(<><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></>);
...
export const IconPrinter = icon(<><polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect x="6" y="14" width="12" height="8"/></>);
export const IconFile = icon(<><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"/><polyline points="13 2 13 9 20 9"/></>);
...
export const IconCurrency = icon(<><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></>);
